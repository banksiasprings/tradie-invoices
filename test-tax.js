...
const api = new Function(m[1] + '\nreturn {fyOf,fyStartDate,fyEndDate,fyLabel,addDaysStr,addYearsStr,mondayOf,logbookEndDate,logbookExpiryDate,tripsInRange,tripsInFy,kmByCat,businessUsePct,taxSummary,logbookPct,logbookExpenseClaim,expensesInFy,fyList,CENTS_KM_CAP};')();
const { fyOf, fyStartDate, fyEndDate, fyLabel, addDaysStr, addYearsStr, mondayOf, logbookEndDate, logbookExpiryDate, tripsInRange, tripsInFy, kmByCat, businessUsePct, taxSummary, logbookPct, logbookExpenseClaim, expensesInFy, fyList, CENTS_KM_CAP } = api;
