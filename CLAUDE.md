...
|---|---|---|---|
| 1 | `www/index.html` | `const APP_VERSION = 'vN'` (line ~1978) | v101.5 |
...
| 4 | `capacitor.config.json` | `CapacitorUpdater.version: "1.N.0"` | 1.101.5 — **bump with APP_VERSION on APK builds** (see v82 cache-trap bug) |
